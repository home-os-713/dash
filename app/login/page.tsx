    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAF9F6] px-4">
      <div className="w-full max-w-sm bg-white rounded-2xl border border-[#EAE8E1] shadow-soft p-8 animate-rise">
        <div className="text-center mb-7">
          ...
          <h1 className="text-2xl font-serif font-bold text-[#2B2B28]">Welcome back</h1>
          <p className="text-sm text-[#6E6B64] mt-1">Sign in to your homeowner dashboard</p>
        </div>
        ...
        <p className="text-center text-sm text-[#6E6B64] mt-6">
          No account?{" "}
          <Link href="/signup" className="text-[#5A6247] font-medium hover:text-[#4A5239] hover:underline">
            Sign up
          </Link>
        </p>
      </div>
